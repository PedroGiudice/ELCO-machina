...
>
    ...
    <div class="flex items-center gap-2">
        ...
        <h2 class="text-sm font-semibold">Texto para Fala (XTTS v2)</h2>
    </div>
    ...
    <section class="space-y-2">
        ...
        <input
            ...
            class="w-full px-3 py-2 bg-[var(--bg-overlay)] border border-[var(--border-subtle)] rounded-[var(--radius-sm)] text-[11px] font-mono focus:outline-none focus:border-[var(--accent)] transition-colors"
            placeholder="https://..."
        >
        <div class="flex items-center gap-2">
            <button
