  ...
  return (
    <div className="p-5 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        {currentUser && (
          <div className="flex items-center gap-2">
            <span className="text-[10px] text-[var(--text-secondary)]">{currentUser}</span>
            <button
              onClick={onLogout}
          ...
          <div className="grid grid-cols-2 gap-2">
            {aiModels.map((model) => (
              ...
              >
                ...
                <span className="text-[9px] text-[var(--text-secondary)]">{model.desc}</span>
              </motion.button>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-3 gap-2">
            {transcriptionModes.map((mode) => (
              <motion.button
                key={mode.id}
                whileTap={{ scale: 0.98 }}
                onClick={() => onTranscriptionModeChange(mode.id)}
              ...
              >
                ...
                <span className="text-[9px] text-[var(--text-secondary)]">{mode.desc}</span>
              </motion.button>
            ))}
          </div>
        ...
        <div>
          ...
          <div className="flex gap-2">
            <input
              ...
              onChange={(e) => onWhisperServerUrlChange(e.target.value)}
